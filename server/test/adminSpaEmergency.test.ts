...
function loadSpa(): SpaTest {
  ...
  src = src.replace(anchor, '\nglobalThis.__test = { state, t, emergencySection, statCard, renderCalls, renderDashboard, pickWsToken, emergenciesCsvRows, emergencyTriageSort, openReportRepeatCounts, reportsTriageSort, trackServerCommit, validateFilterTerms };\nrender();')
  const noop = (): void => {}
