...
enum HomeStrings {
    ...
    static func voiceCommandsHelp(_ l: Language) -> String {
        l == .zh
            ? "你可以说：开始导盲、带我去某地、坐公交去某地、回家、去公司、看一看、读一下文字、读整页、看看保质期、读电话号码、读邮箱、认一下钱、数一叠钱、扫个码、这是几路车、找我的钥匙、最近的厕所在哪、我在哪、周围有什么、前方有什么、有没有人、我朝哪个方向、这是什么颜色、这两件搭不搭、光线怎么样、天气、现在几点、还有多少电、今天几号、给某人发消息、给某人打电话、把位置发给某人、读一下消息、打开消息、打开设置、再说一遍、说慢点、说快点、说简短点、说详细点。需要人帮忙说\u{201C}求助\u{201D}；遇到危险说\u{201C}救命\u{201D}，会倒计时通知你的全部亲友。"
