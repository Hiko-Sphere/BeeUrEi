...
const I18N = {
  zh: {
    ...
    emergTitle: '紧急事件（近 100 条）', emergEmpty: '暂无紧急事件', emergKind_fall: '疑似摔倒', emergKind_crash: '疑似撞击', emergKind_manual: '手动 SOS', emergNotified: '推送', emergContacts: '亲友', emergLive: '实时位置', emergLastKnown: '最后已知', emergNoLoc: '无位置', emergResolved: '已报平安',
  ...
  en: {
    ...
    emergTitle: 'Emergency events (last 100)', emergEmpty: 'No emergency events', emergKind_fall: 'Suspected fall', emergKind_crash: 'Suspected crash', emergKind_manual: 'Manual SOS', emergNotified: 'pushed', emergContacts: 'contacts', emergLive: 'live location', emergLastKnown: 'last known', emergNoLoc: 'no location', emergResolved: 'resolved',
  ...
  const rows = list.length === 0
    ...
    : list.slice(0, 20).map((e) => {
        ...
        return `<div class="bar-row"><span class="pill ${e.kind === 'manual' ? '' : 'danger'}">${esc(kind)}</span>
          <span>${who}</span><span>${loc}</span>${resolved}
