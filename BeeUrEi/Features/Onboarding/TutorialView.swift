        ...
        case .zh:
            steps = [
                ...
                TutorialStep(icon: "mic.fill", title: "开口就能用",
                             body: "点首屏的麦克风按钮说话：\u{2018}带我去超市\u{2019}\u{2018}读一下\u{2019}\u{2018}找我的钥匙\u{2019}\u{2018}我在哪\u{2019}都可以。不知道说什么，就问\u{2018}你会什么\u{2019}；嫌快嫌慢就说\u{2018}说慢点\u{2019}\u{2018}说快点\u{2019}。"),
        ...
        case .en:
            steps = [
                ...
                TutorialStep(icon: "mic.fill", title: "Just speak",
                             body: "Tap the mic on the home screen and talk: \u{201C}take me to the store\u{201D}, \u{201C}read this\u{201D}, \u{201C}find my keys\u{201D}, \u{201C}where am I\u{201D}. Not sure? Ask \u{201C}what can you do\u{201D}. Too fast or slow? Say \u{201C}speak slower\u{201D} or \u{201C}speak faster\u{201D}."),
